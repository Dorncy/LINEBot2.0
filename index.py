...
import openai
# openai.api_key = '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'         # 你的 OpenAI API KEY
...
def linebot():
    ...
    print(json_data)
    try:
        token = 'fQwq3WxVDWecwsXXww4M7y8eXsDMJnkZNHaTHsn7aZQqQ4ATzjEeRyW5rcywuKSG1ORfYRF+tPZhjGAlulNUucYmb1nQ9E+M7DjZ6wNR0Ja5U0/fPB2JCCH7x6qhMe93iWzkWRLUAdhKEKqcHJ7pyAdB04t89/1O/w1cDnyilFU='        # 你的 Access Token
        secret = '190d5a874b15b38c9f5398d2f33e6dbd'     # 你的 Channel Secret
